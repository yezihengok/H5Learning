...
$(function () {
    ...
    //在克隆marquee里面所有的行（row）,实现循环滚动的样子
...
var charts = [];
/**
 * 默认数组 添加元素需要指定索引添加:array[1]=10 ,这里默认新添加元素到数组末尾
 * @param {Array} array 
 * @param {Object} e 
 */
function arrayAppend(array, e) {
...
function getSales() {
    ...
    $(".sales .caption").on("click", "a", function () {
        ...
        // this.dataset.type 标签上的data-type自定义属性，对应data中的属性    
        var arr = data[this.dataset.type];
        // arr 当前对应的数据  
        console.log(`this.dataset.type=${this.dataset.type}`);
        //   console.log(arr);
