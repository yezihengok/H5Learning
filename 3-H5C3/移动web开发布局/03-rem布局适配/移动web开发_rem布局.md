...
③每一份作为html字体大小（htmlfont-size ），这里就是50px

④那么在320px设备的时候，字体大小（htmlfont-size ）为320/15就是  21.33px
...
每一份 html font-size 字体大小 =  屏幕宽度  /  划分的份数

公式：页面元素的rem值 =  页面元素值（px） /  htmlfont-size （屏幕宽度  /  划分的份数）
